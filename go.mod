...
require (
	...
	github.com/melisource/fury_go-core v1.11.1 // indirect
	github.com/melisource/fury_go-toolkit-mlauth v0.2.7 // indirect
	github.com/melisource/fury_go-toolkit-otel v0.4.4 // indirect
